...
opening a [GitHub issue](https://github.com/karnarokEpoch/margot/issues) or, if the
report involves sensitive details you'd rather not post publicly, by contacting the
repository maintainers directly through GitHub. All complaints will be reviewed and
